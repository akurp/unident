 ...
 * https://jqueryvalidation.org/ Copyright (c) 2019 Jörn Zaefferer; Licensed MIT
 * 
 */
!function (a) {
    ...
    a.extend(a.fn, {
        ...
        rules: function (b, c) {
            var d,
                ...
                i,
                j = this[0],
                k = "undefined" != typeof this.attr("contenteditable") && "false" !== this.attr(
                    "contenteditable"
                );
            if (null != j && (!j.form && k && (j.form = this.closest("form")[0], j.name = this.attr(
                ...
                if (b) 
                    switch (
                        ...
                        case "remove":
                            return c
                                ? (i = {}, a.each(c.split(/\s/), function (a, b) {
                                    i[b] = f[b],
                                    delete f[b]
                                }), i)
                                : (delete e[j.name], f)
    ...
    a.extend(a.validator, {
        defaults: {
            ...
            onfocusout: function (a) {
                this.checkable(a) || !(a.name in this.submitted) && this.optional(a) || this.element(
                    a
                )
            },
            onkeyup: function (b, c) {
                ...
                9 === c.which && "" === this.elementValue(b) || a.inArray(c.keyCode, d) !== -1 || (
        ...
        prototype: {
            init: function () {
                function b(b) {
                    var c = "undefined" != typeof a(this).attr("contenteditable") && "false" !== a(
                        this
                    ).attr("contenteditable");
                    if (!this.form && c && (this.form = a(this).closest("form")[0], this.name = a(
                        this
                ...
                this.errorContext = this.labelContainer.length && this.labelContainer || a(
                    this.currentForm
                ),
                ...
                a(this.currentForm)
                    .on(
                        ...
                        ":text, [type='password'], [type='file'], select, textarea, [type='number'], [t" +
                                ...
                                "ocal'], [type='range'], [type='color'], [type='radio'], [type='checkbox'], [co" +
                                "ntenteditable], [type='button']",
                        b
                    )
                    .on("click.validate", "select, option, [type='radio'], [type='checkbox']", b),
                this.settings.invalidHandler && a(this.currentForm).on(
                ...
                if (this.settings.unhighlight) 
                    for (b = 0; a[b]; b++) 
                        this
                            .settings
                            .unhighlight
                            .call(this, a[b], this.settings.errorClass, ""),
                        this
                            .findByName(a[b].name)
            ...
            findLastActive: function () {
                ...
                return b && 1 === a
                    .grep(this.errorList, function (a) {
                ...
                return a(this.currentForm)
                    ...
                    .filter(function () {
                        var d = this.name || a(this).attr("name"),
                            e = "undefined" != typeof a(this).attr("contenteditable") && "false" !== a(
                                this
                            ).attr("contenteditable");
            ...
            check: function (b) {
                ...
                for (d in g) {
                    ...
                    try {
                        ...
                        k instanceof TypeError && (
                            k.message += ".  Exception occurred when checking element " + b.id + ", check the '" + e.method +
                                "' method."
                        ),
                        k
                    }
                ...
                if (!i) 
                    return this.objectLength(g) && this
                        .successList
                        .push(b),
                    !0
            },
            ...
            formatAndAdd: function (a, b) {
                ...
                this
                    .errorList
                    .push({message: c, element: a, method: b.method}),
            ...
            defaultShowErrors: function () {
                ...
                for (a = 0; this.errorList[a]; a++) 
                    ...
                    this.settings.highlight && this
                        .settings
                        .highlight
                        .call(this, c.element, this.settings.errorClass, this.settings.validClass),
            ...
            showLabel: function (b, c) {
                ...
                h.length
                    ...
                    : (
                        ...
                        d = h,
                        this.settings.wrapper && (d = h.hide().show().wrap(
                        ...
                        h.is("label")
                            ...
                            : 0 === h.parents("label[for='" + this.escapeCssMeta(i) + "']").length && (
                                ...
                                e && (g = this, a.each(g.groups, function (b, c) {
            ...
            stopRequest: function (b, c) {
                ...
                c && 0 === this.pendingRequest && this.formSubmitted && this.form()
                    ? (a(this.currentForm).submit(), this.submitButton && a(
                        "input:hidden[name='" + this.submitButton.name + "']",
                        this.currentForm
                    ).remove(), this.formSubmitted = !1)
                    : !c && 0 === this.pendingRequest && this.formSubmitted && (
        ...
        classRules: function (b) {
            ...
            return d && a.each(d.split(" "), function () {
                this in a.validator.classRuleSettings && a.extend(
                    c,
        ...
        normalizeRules: function (b, c) {
            ...
            a.each(b, function (d, e) {
                b[d] = a.isFunction(e) && "normalizer" !== d
                    ? e(c)
                    : e
            }),
            a.each([
            ...
            a.validator.autoCreateRanges && (
                null != b.min && null != b.max && (b.range = [
                    b.min, b.max
                ], delete b.min, delete b.max),
                null != b.minlength && null != b.maxlength && (b.rangelength = [
        ...
        addMethod: function (b, c, d) {
            ...
            c.length < 3 && a
                .validator
                .addClassRules(b, a.validator.normalizeRule(b))
        },
        methods: {
            ...
            url: function (a, b) {
                return this.optional(b) || /^(?:(?:(?:https?|ftp):)?\/\/)(?:\S+(?::\S*)?@)?(?:(?!(?:10|127)(?:\.\d{1,3}){3})(?!(?:169\.254|192\.168)(?:\.\d{1,3}){2})(?!172\.(?:1[6-9]|2\d|3[0-1])(?:\.\d{1,3}){2})(?:[1-9]\d?|1\d\d|2[01]\d|22[0-3])(?:\.(?:1?\d{1,2}|2[0-4]\d|25[0-5])){2}(?:\.(?:[1-9]\d?|1\d\d|2[0-4]\d|25[0-4]))|(?:(?:[a-z\u00a1-\uffff0-9]-*)*[a-z\u00a1-\uffff0-9]+)(?:\.(?:[a-z\u00a1-\uffff0-9]-*)*[a-z\u00a1-\uffff0-9]+)*(?:\.(?:[a-z\u00a1-\uffff]{2,})).?)(?::\d{2,5})?(?:[\/?#]\S*)?$/i.test(
                    a
                )
            },
            date: function () {
                ...
                return function (b, c) {
                    return a || (a = !0, this.settings.debug && window.console && console.warn(
                        ...
                        "e don't use it, since it relies on the Date constructor, which\nbehaves very d" +
                        "ifferently across browsers and locales. Use `dateISO`\ninstead or one of the l" +
                        "ocale specific methods in `localizations/`\nand `additional-methods.js`."
                    )),
                    this.optional(c) || !/Invalid|NaN/.test(new Date(b).toString())
                }
            }(),
            dateISO: function (a, b) {
                return this.optional(b) || /^\d{4}[\/\-](0?[1-9]|1[012])[\/\-](0?[1-9]|[12][0-9]|3[01])$/.test(
                    a
                )
            },
            number: function (a, b) {
                return this.optional(b) || /^(?:-?\d+|-?\d{1,3}(?:,\d{3})+)?(?:\.\d+)?$/.test(
                    a
                )
            },
            digits: function (a, b) {
            ...
            equalTo: function (b, c, d) {
                var e = a(d);
                return this.settings.onfocusout && e
                    .not(".validate-equalTo-blur")
                    .length && e
            ...
            remote: function (b, c, d, e) {
                ...
                return this
                    .settings
                    .messages[c.name] || (this.settings.messages[c.name] = {}),
                i.originalMessage = i.originalMessage || this
                    .settings
                    .messages[c.name][e],
                this
                    .settings
                    .messages[c.name][e] = i.message,
                d = "string" == typeof d && {
                    url: d
                } || d,
                h = a.param(a.extend({
                    ...
                    : (
                        ...
                        a.ajax(a.extend(!0, {
                            ...
                            success: function (a) {
                                ...
                                f
                                    .settings
                                    .messages[c.name][e] = i.originalMessage,
                                j
                                    ? (
                                        h = f.formSubmitted,
                                        f.resetInternals(),
